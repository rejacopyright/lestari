...
@endsection
@section('content')
<form class="" action="{{url('admin/promo/store')}}" method="post" enctype="multipart/form-data">
  @csrf
  <div class="px-4 pt-3">
    <div class="row">
      ...
      <div class="col">
        <div class="dashboard-box m-0 p-3">
          <div class="mb-2">
            <input type="text" class="flat" name="title" placeholder="Promo Title" required>
          </div>
          <div class="mb-2">
            <p class="m-0 text-muted">Promo Description</p>
            <textarea name="description" class="flat summernote" placeholder="Promo Description"></textarea>
          </div>
