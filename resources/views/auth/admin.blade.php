...
<head>
  ...
  <link href="{{url('public')}}/css/colors/blue.css" rel="stylesheet">
  <style media="screen">
      ...
      <div class="form-holder col-md-6 m-0">
        <div class="form-content">
          <div class="form-items row">
            ...
            <p class="text-center font-16"><a href="{{url('/')}}" class="text-info strong">{{config('app.name')}}</a> | <span class="teks">Login</span></p>
